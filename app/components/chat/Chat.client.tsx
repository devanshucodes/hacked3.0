...
export const ChatImpl = memo(
  ({ description, initialMessages, storeMessageHistory, importChat, exportChat }: ChatProps) => {
    ...
    useEffect(() => {
      // Check if we have an agent to load from navigation
      const state = location.state as { loadAgent?: any };
      if (state?.loadAgent && importChat) {
        importChat(state.loadAgent.name, state.loadAgent.messages);
