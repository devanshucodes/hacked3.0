...
export const BaseChat = React.forwardRef<HTMLDivElement, BaseChatProps>(
  (
    ...
    const handleSaveAsAgent = () => {
      ...
      try {
        saveAgent(name, description, messages || []);
        toast.success('Agent saved successfully! View it in AI Ecosystem.');
      } catch (error) {
          ...
          >
            ...
            {!chatStarted && (
              ...
              >
                <Link 
                  to="/ai-ecosystem"
                  className="inline-block mb-6 px-6 py-3 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 transition-colors"
                >
                  AI Agent Ecosystem
                </Link>
                      ...
                      <div className="flex gap-1 items-center">
                        ...
                        {chatStarted && (
                          <div>
                            ...
                            >
                              <div className="i-bolt:save text-l text-blue-500 mr-1" />
                              <span className="text-l text-blue-500 mr-1">
                                Save Agent
                              </span>
                            </IconButton>
